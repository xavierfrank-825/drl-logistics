  ...
  return (
    <section id="products" className="py-32 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 perspective-1000">
            ...
            return (
              ...
              >
                <div className="glass p-4 rounded-[2rem] border-white/5 group-hover:border-primary/30 transition-colors duration-500 shadow-xl h-full flex flex-col">
                  <div className="aspect-square rounded-[1.5rem] overflow-hidden relative mb-6 bg-gradient-to-br from-primary/10 to-secondary/10 flex items-center justify-center">
                    <motion.div
                      animate={{ 
                        rotateY: [0, 360],
                        scale: [1, 1.1, 1]
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-8">
                      <p className="text-white font-black uppercase tracking-tight text-xl">{product.name}</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between px-2 mt-auto">
                    <div className="flex flex-col">
                      ...
                      <span className="text-2xl font-black text-glow">{product.units} Units</span>
                    </div>
