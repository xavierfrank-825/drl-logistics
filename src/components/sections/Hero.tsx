      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-24 items-center mb-32">
          ...
          >
            ...
            <h1 className="text-7xl md:text-8xl font-black uppercase tracking-tighter leading-[0.8] mb-8 text-glow">
              Future <br />
            ...
            <div className="flex flex-wrap gap-6">
              <button className="bg-primary hover:bg-primary/80 text-white px-10 py-5 rounded-full font-bold uppercase text-[12px] tracking-[2px] transition-all duration-300 hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(46,91,255,0.4)]">
                Explore Model
              </button>
              <button className="glass hover:bg-white/10 text-white px-10 py-5 rounded-full font-bold uppercase text-[12px] tracking-[2px] transition-all duration-300">
                View Products
              </button>
            </div>
          </motion.div>
          ...
          >
            <motion.div 
              ...
              className="preserve-3d max-w-[420px] ml-auto"
            >
              <div className="glass p-4 rounded-[3rem] border-white/10 shadow-2xl">
                <div className="aspect-[4/5] rounded-[2.5rem] overflow-hidden relative bg-gradient-to-br from-primary/20 via-secondary/20 to-primary/20 flex items-center justify-center">
                  <motion.div
                    animate={{ rotate: 360 }}
                    transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                    className="w-40 h-40 border-2 border-primary/20 rounded-[3rem] relative"
                  >
                    <div className="absolute inset-0 border-2 border-secondary/20 rounded-[3rem] rotate-45" />
                  </motion.div>
        ...
        <motion.div 
          ...
          className="glass border border-white/5 rounded-[2.5rem] p-10"
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
            {[
              ...
              <div key={i} className="flex flex-col gap-2">
                <span className="text-[10px] font-bold uppercase tracking-[2px] text-muted-foreground">{stat.label}</span>
                <span className="text-3xl font-black text-glow">{stat.value}</span>
              </div>
            ))}
          </div>
        </motion.div>
